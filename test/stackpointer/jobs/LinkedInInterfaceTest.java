...
public class LinkedInInterfaceTest {
    ...
    public void testretrieveJobPostings() {
        ...
        LinkedInInterface instance = new LinkedInInterface();
        boolean expResult = true;
        boolean result = instance.retrieveJobPostings();
       assertEquals(expResult, result);
    }
    ...
    /**
     * Test of googleMaps method, of class LinkedInInterface.
     */
